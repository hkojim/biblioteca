package miyamoto.biblioteca.infrastructure.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,"/autores").permitAll() // Permite acesso ao endpoint de login sem autenticação
                        .requestMatchers(HttpMethod.POST,"/obras").permitAll() // Permite acesso ao endpoint de login sem autenticação
                        .requestMatchers(HttpMethod.GET, "/autores/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/obras/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/autores/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/obras/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/autores/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/obras/**").permitAll()


                        .requestMatchers(HttpMethod.POST, "/autores").permitAll() // Permite acesso ao endpoint POST /usuario sem autenticação
                        .requestMatchers(HttpMethod.GET, "/usuario/endereco/**").permitAll()
                        .requestMatchers("/autores/**").authenticated() // Requer autenticação para qualquer endpoint que comece com /usuario/
